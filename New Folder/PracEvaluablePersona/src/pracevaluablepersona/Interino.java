...
public class Interino extends Profesor{
        private final int HORASMAX=10;
        private final double PRECIOHORA=  15;
        private final double IRPF= 0.90;
        ...
        public Interino(String nombre,String apellidos,int edad, int numHoras,String centro){
          this.nombre=nombre;
    ...
    public String getNombre(){
            ...
            return ("Profesor interino: "+ nombre);
        }
